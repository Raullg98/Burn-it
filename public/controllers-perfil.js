var app = angular.module('proyecto', ['ngResource', 'emguo.poller', 'ngRoute']);

app.config(function($locationProvider) {
    $locationProvider.html5Mode(true);
});

app.controller('controller', ['$scope', '$resource', 'poller', '$http', '$location',
    function($scope, $resource, poller, $http, $location) {
        ...
        $http(reqperfil).then(function successCallback(response) {
            ...
            try {
                ...
                if (response.data.User != 'undefined') {
                    console.log(response);
                    $scope.perfil = response.data.User[0];
                }
            ...
            console.log("Error en solicitud de PERFIL");
        });
